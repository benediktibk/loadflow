        ...
        public INodeVoltageCalculator CreateNodeVoltageCalculator(Selection selection)
        {
            switch (selection)
            {
                ...
                case Selection.HolomorphicEmbeddedLoadFlowWithCurrentIteration:
                    return new HolomorphicEmbeddedLoadFlowMethodWithIterativeMethod(TargetPrecision, 50, 64, new CurrentIteration(TargetPrecision, MaximumIterations));
                case Selection.HolomorphicEmbeddedLoadFlowWithNewtonRaphson:
                    return new HolomorphicEmbeddedLoadFlowMethodWithIterativeMethod(TargetPrecision, 50, 64, new NewtonRaphsonMethod(TargetPrecision, MaximumIterations));
                default:
