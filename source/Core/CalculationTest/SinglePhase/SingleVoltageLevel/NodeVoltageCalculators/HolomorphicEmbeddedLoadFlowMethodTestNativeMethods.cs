...
namespace CalculationTest.SinglePhase.SingleVoltageLevel.NodeVoltageCalculators
{
    class HolomorphicEmbeddedLoadFlowMethodTestNativeMethods
    {
        ...
        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsLinearEquationSystemSix();

        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsLinearEquationSystemSeven();
        ...
        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsSparseMatrixTranspose();

        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsSparseMatrixPermutateRows();
        ...
        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsGraphCreateLayeringFrom();

        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsGraphFindPseudoPeriphereNode();

        [DllImport("HELM.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool RunTestsGraphFindPseudoPeriphereNodeOfAdmittanceMatrix();
    }
}