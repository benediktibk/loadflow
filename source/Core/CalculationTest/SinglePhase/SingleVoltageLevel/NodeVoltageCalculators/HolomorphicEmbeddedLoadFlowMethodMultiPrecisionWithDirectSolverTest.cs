...
{
    [TestClass]
    public class HolomorphicEmbeddedLoadFlowMethodMultiPrecisionWithDirectSolverTest : NodeVoltageCalculatorTest
    {
        ...
        {
            return new HolomorphicEmbeddedLoadFlowMethod(0.0000001, 70, 100, false);
        }
    }
}
