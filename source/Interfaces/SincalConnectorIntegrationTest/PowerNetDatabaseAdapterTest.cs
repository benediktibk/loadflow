...
namespace SincalConnectorIntegrationTest
{
    ...
    public class PowerNetDatabaseAdapterTest
    {
        ...
        [TestMethod]
        public void CalculateNodeVoltages_NetWithTwoFeedInsInDifferentNets_AllTableEntriesAreCorrect()
        {
            var powerNet = new PowerNetDatabaseAdapter("testdata/calculation_feedin3_files/database.mdb");
            var sincalResults = powerNet.GetNodeResultTableEntriesFromDatabase();
        ...
        [TestMethod]
        public void CalculateNodeVoltages_NetWithShuntReactanceVersionSix_ResultsAreCorrect()
        {
            var powerNet = new PowerNetDatabaseAdapter("testdata/calculation_shuntreactance6_files/database.mdb");
            var sincalResults = powerNet.GetNodeResultsFromDatabase();
            ...
            var ownResults = powerNet.GetNodeResultsFromDatabase();
            AreVoltagesEqual(sincalResults, ownResults, 0.0001);
            ArePowersEqual(sincalResults, ownResults, 1);
        }
