...
namespace SincalConnectorIntegrationTest
{
    ...
    public class PowerNetDatabaseAdapterTest
    {
        ...
        [TestMethod]
        public void CalculateNodeVoltages_NetWithFeedInVersionOne_ResultsAreCorrect()
        {
            var powerNet = new PowerNetDatabaseAdapter("testdata/calculation_feedin1_files/database.mdb");
            var sincalResults = powerNet.GetNodeResultsFromDatabase();
