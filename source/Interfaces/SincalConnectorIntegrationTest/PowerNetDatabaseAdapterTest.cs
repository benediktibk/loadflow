...
namespace SincalConnectorIntegrationTest
{
    ...
    public class PowerNetDatabaseAdapterTest
    {
        ...
        [TestMethod]
        public void CalculateNodeVoltages_NetWithParallelSystemsVersionTwo_AllTableEntriesAreCorrect()
        {
            var powerNet = new PowerNetDatabaseAdapter("testdata/calculation_transmissionline11_files/database.mdb");
            var sincalResults = powerNet.GetNodeResultTableEntriesFromDatabase();
