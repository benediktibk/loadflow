...
namespace CalculationComparison
{
    public class Calculator
    {
        ...
        private static PowerNet CreatePowerNetWithUnsymmetricMatrixAndPQBusses(out Vector<Complex> correctVoltages, out bool voltageCollapse)
        {
            ...
            powerNet.Admittances.AddConnection(0, 1, new Complex(100, 200));
            powerNet.Admittances.AddConnection(0, 2, new Complex(50, -100));
            powerNet.Admittances.AddConnection(1, 2, new Complex(200, 600));
            powerNet.Admittances.AddUnsymmetricAdmittance(1, 2, new Complex(4, 1));
            powerNet.Admittances.AddUnsymmetricAdmittance(2, 1, new Complex(-4, -1));
        ...
        {
            var powerNet = new PowerNet(3, 1);
            powerNet.Admittances.AddConnection(0, 1, new Complex(1000, 500));
            powerNet.Admittances.AddConnection(0, 2, new Complex(200, -200));
            powerNet.Admittances.AddConnection(1, 2, new Complex(100, 300));
        ...
        private static PowerNet CreatePowerNetThreeNodeSystemWithTwoPVBuses(out Vector<Complex> correctVoltages, out bool voltageCollapse)
        {
            var powerNet = new PowerNet(3, 1);
            powerNet.Admittances.AddConnection(0, 1, new Complex(1000, 500));
            powerNet.Admittances.AddConnection(0, 2, new Complex(0, 0));
            powerNet.Admittances.AddConnection(1, 2, new Complex(100, 300));
            correctVoltages = new DenseVector(3);
            correctVoltages[0] = new Complex(1, 0.2);
            correctVoltages[1] = new Complex(1.1, -0.1);
        ...
        private static PowerNet CreatePowerNetForFiveNodeSystemWithFourPQBuses(out Vector<Complex> correctVoltages, out bool voltageCollapse)
        {
            ...
            powerNet.Admittances.AddConnection(0, 1, new Complex(1000, 500));
            powerNet.Admittances.AddConnection(0, 2, new Complex(0, 0));
            powerNet.Admittances.AddConnection(0, 3, new Complex(200, -100));
            powerNet.Admittances.AddConnection(0, 4, new Complex(0, -200));
            powerNet.Admittances.AddConnection(1, 2, new Complex(100, 300));
            powerNet.Admittances.AddConnection(1, 3, new Complex(0, 0));
            powerNet.Admittances.AddConnection(1, 4, new Complex(0, 0));
            powerNet.Admittances.AddConnection(2, 3, new Complex(200, -500));
            powerNet.Admittances.AddConnection(2, 4, new Complex(0, 0));
            powerNet.Admittances.AddConnection(3, 4, new Complex(700, 500));
        ...
        {
            var powerNet = new PowerNet(2, 1);
            powerNet.Admittances.AddConnection(0, 1, new Complex(1000, 2000));
        ...
        public static PowerNet CreatePowerNetForCollapsingTwoNodeSystem(out Vector<Complex> correctVoltages, out bool voltageCollapse)
        {
            ...
            powerNet.SetNode(0, supplyNode);
            powerNet.SetNode(1, loadNode);
            powerNet.Admittances.AddConnection(0, 1, new Complex(1, 2));
        ...
        private void CalculateHolomorphicEmbeddingLoadFlowResult()
        {
            var calculator = new HolomorphicEmbeddedLoadFlowMethod(_holomorphicEmbeddedLoadFlow.TargetPrecision,
                _holomorphicEmbeddedLoadFlow.MaximumNumberOfCoefficients, new PrecisionLongDouble());
