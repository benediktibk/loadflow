...
namespace CalculationTest.ThreePhase
{
    ...
    public class SymmetricPowerNetTest
    {
        ...
        public void CalculateNodeVoltages_CompletePowerNet_CorrectResults()
        {
            ...
            _powerNet.AddTransmissionLine(1, 2, 0.1, 0.4 / omega, 100.0 / (1000 * 1000), 1e-10, 10, true);
            _powerNet.AddTransmissionLine(2, 3, 0.1, 0.4 / omega, 100.0 / (1000 * 1000), 1e-10, 1, true);
            _powerNet.AddTransmissionLine(4, 5, 0.1, 0.4 / omega, 100.0 / (400 * 400), 1e-10, 0.1, true);
            _powerNet.AddTransmissionLine(5, 6, 0.1, 0.4 / omega, 100.0 / (400 * 400), 1e-10, 0.1, true);
            _powerNet.AddTransmissionLine(6, 7, 0.1, 0.4 / omega, 100.0 / (400 * 400), 1e-10, 1, true);
