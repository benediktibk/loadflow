...
\begin{enumerate}
	\item Calculate the next coefficients with
	\begin{equation}
		\sum_i Y_{ki} c_{i,n} = 
		\begin{cases}
	...
	\item Repeat these steps until the voltage change is small enough \emph{or} repeat until the power mismatch is small enough
\end{enumerate}
