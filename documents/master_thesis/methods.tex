...
\end{equation}
\begin{equation}
	\frac{\partial P_k}{\partial U_i^r} = \sum_{i \ne k} \left( U_k^r Y_{ki}^r + U_k^i Y_{ki}^i \right)
\end{equation}
\begin{equation}
	\frac{\partial P_k}{\partial U_i^i} = \sum_{i \ne k} \left( U_k^i Y_{ki}^r - U_k^r Y_{ki}^i \right)
\end{equation}
\begin{equation}
	\frac{\partial Q_k}{\partial U_i^r} = \sum_{i \ne k} \left( U_k^i Y_{ki}^r - U_k^r Y_{ki}^i \right)
\end{equation}
\begin{equation}
	\frac{\partial Q_k}{\partial U_i^i} = \sum_{i \ne k} \left( - U_k^r Y_{ki}^r - U_k^i Y_{ki}^i \right)
\end{equation}
