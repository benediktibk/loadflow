...
A transmission line is modelled only with admittances like in \figref{transmission_line}. The values $Y_q$ and $Y_l$ can be derived from the wave impedance $Z_W$ and the propagation constant $\gamma$ of the transmission line through
\begin{equation}
	MISSING
\end{equation}
and
\begin{equation}
	MISSING,
\end{equation}
as shown in \citep[p. 155]{powerSystemAnalysis}.
